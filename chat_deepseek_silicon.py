...
url_image = "https://api.siliconflow.cn/v1/images/generations"  # 图像生成API
model = "deepseek-ai/DeepSeek-R1"
model_image = "Kwai-Kolors/Kolors"  # 多模态模型

# 初始化系统角色
messages = [
    {"role": "system", "content": "你是一个智能助手，可以回答用户的各种问题。"}
]
...
def generate_image(prompt, size="1024x1024", n=1):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # 处理提示词作为文件名（移除特殊字符）
            safe_prompt = re.sub(r'[\\/:*?"<>|]', '_', prompt)[:50]  # 限制长度为50个字符
